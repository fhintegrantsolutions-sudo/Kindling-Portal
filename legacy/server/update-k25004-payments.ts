// K25004 first payment was December 25, 2025
// Current date is February 10, 2026
// Payments are on the 25th of each month
// Payments made: December 2025 through January 2026 = 2 payments
...
async function updateK25004Payments() {
  console.log("Updating K25004 payment history...\n");
  ...
  console.log(`Found K25004 note with ID: ${noteId}\n`);

  // Get all participations for K25004
  ...
  for (const participationDoc of participationsSnapshot.docs) {
    ...
    const annualRate = parseFloat(noteData.rate) / 100; // 9.5%
    const termMonths = 60;
