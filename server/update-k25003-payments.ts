...
// K25003 first payment was September 25, 2025
// Current date is February 9, 2026
// Payments are on the 25th of each month
// Payments made: September 2025 through January 2026 = 5 payments
...
async function updateK25003Payments() {
  console.log("Updating K25003 payment history...\n");
  ...
  console.log(`Found K25003 note with ID: ${noteId}\n`);

  // Get all participations for K25003
